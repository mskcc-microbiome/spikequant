...
curl -o - ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/013/045/GCA_000013045.1_ASM1304v1/GCA_000013045.1_ASM1304v1_genomic.gff.gz | gunzip | grep  $'\trRNA\t' > ${outdir}/Salinibacter_ruber_rrna.bed.tmp
# create genome file
...
# create non-rRNA bed
bedtools complement -i ${outdir}/Salinibacter_ruber_rrna.bed.tmp -g benchmarking/spikes/raw/Salinibacter_ruber.fa.fai > ${outdir}/Salinibacter_ruber_nonrrna.bed
# create marker bed
...
curl -o - ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCF/008/729/095/GCF_008729095.1_ASM872909v1/GCF_008729095.1_ASM872909v1_genomic.gff.gz | gunzip | grep  $'\trRNA\t' > ${outdir}/Haloarcula_hispanica_rrna.bed.tmp
# create genome file
...
# create non-rRNA bed
bedtools complement -i ${outdir}/Haloarcula_hispanica_rrna.bed.tmp -g benchmarking/spikes/raw/Haloarcula_hispanica.fa.fai > ${outdir}/Haloarcula_hispanica_nonrrna.bed
# create marker bed
