...
#system("scp lilac:/data/brinkvd/users/watersn/spikequant/benchmarking/v3_res.tsv ./")
res = read.csv("v3_res.tsv" , sep="\t", header=FALSE, col.names = c("rawsample", "spike", "len", "nreads") )%>% 
